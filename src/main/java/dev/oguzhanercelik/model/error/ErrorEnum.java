...
public enum ErrorEnum {
    ...
    TOP_NOT_FOUND(1005, "top.not.found", HttpStatus.NOT_FOUND),
    BOTTOM_NOT_FOUND(1005, "bottom.not.found", HttpStatus.NOT_FOUND),
    SHOES_NOT_FOUND(1005, "shoes.not.found", HttpStatus.NOT_FOUND);
